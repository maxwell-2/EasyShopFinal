...
=======
    <!-- Carousel Start 
    <div style="" class="container-fluid mb-3 ml-5 mt-0">
        <div style="" class="row px-xl-5">
>>>>>>> 7182a1c (site e-commerce easyShop final)
...
=======
                            <img class="position-relative w-100 h-100" src="{{asset('img/mode-vetement.jpg')}}" style="object-fit: cover;">
>>>>>>> 7182a1c (site e-commerce easyShop final)
...
=======
                            <img class="position-relative w-100 h-100" src="{{asset('img/cat_chaussure.jpg')}}" style="object-fit:cover;">
>>>>>>> 7182a1c (site e-commerce easyShop final)
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
...
=======
                            <img class="position-relative w-100 h-100" src="{{asset('img/mode-outils.jpg')}}" style="object-fit: cover;">
>>>>>>> 7182a1c (site e-commerce easyShop final)
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
        ...
        <div class="row px-xl-5 w-100">
                ...
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{asset('img/mode-vetement.jpg')}}" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Mode Vêtements</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Découvrez notre collection exclusive de vêtements tendance et élégants, conçus pour vous démarquer.</p>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Mode chaussures</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Explorez notre gamme exceptionnelle de chaussures élégantes et confortables, parfaites pour chaque occasion.</p>
                                </div>   
                            </div>
                        </div>
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="{{asset('img/mode-outils.jpg')}}" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                 <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Outils Informatiques</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Découvrez nos outils informatiques de pointe,pour vous offrir une expérience technologique inégalée.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="{{asset('img/image_apropos.jpg')}}" alt="">
                    <div class="offer-text">  
                        <h5 class="text-white mb-3">Offres spéciales</h5>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 200px;">
                    <img class="img-fluid" src="{{asset('img/enjoy.png')}}" alt="">
                    <div class="offer-text">
                        <h5 class="text-white mb-3">Achats sécurisés</h5>
                    </div>
                </div>
            </div>
        </div>
...
=======
    <div class="container-fluid bg-dark text-secondary mt-5 pt-3 pl-5   ">
>>>>>>> 7182a1c (site e-commerce easyShop final)
...
=======
                    ...
                    <div class="col-md-4 mb-5 ">
                        <h6 class="text-secondary text-uppercase mt-5 mb-3">Nous suivre</h6>
>>>>>>> 7182a1c (site e-commerce easyShop final)
                        <div class="d-flex">
